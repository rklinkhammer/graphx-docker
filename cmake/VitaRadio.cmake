...
add_library(graphx-vita-recorder-core STATIC src/vita/recorder.cpp)
target_link_libraries(graphx-vita-recorder-core PUBLIC graphx)
graphx_enable_analysis(graphx-vita-recorder-core)
graphx_enable_sanitizers(graphx-vita-recorder-core)
add_executable(graphx-vita-recorder apps/vita-recorder/main.cpp)
target_link_libraries(graphx-vita-recorder PRIVATE graphx-vita-recorder-core)
graphx_enable_analysis(graphx-vita-recorder)
graphx_enable_sanitizers(graphx-vita-recorder)
if(GRAPHX_BUILD_TESTS OR GRAPHX_QUALIFICATION_HOOKS)
  add_executable(graphx-vita-recorder-test tests/test_vita_recorder.cpp)
  target_link_libraries(graphx-vita-recorder-test PRIVATE graphx-vita-recorder-core)
  graphx_enable_analysis(graphx-vita-recorder-test)
  graphx_enable_sanitizers(graphx-vita-recorder-test)
  add_test(NAME graphx-vita-recorder COMMAND graphx-vita-recorder-test)
  set_tests_properties(graphx-vita-recorder PROPERTIES TIMEOUT 15)
endif()
if(GRAPHX_BUILD_TESTS)
  add_test(NAME graphx-vita-network-contract COMMAND ${Python3_EXECUTABLE}
...
if(GRAPHX_BUILD_TESTS)
  add_test(NAME graphx-vita-live-contract COMMAND ${Python3_EXECUTABLE}
    ${CMAKE_SOURCE_DIR}/tests/test_vita_live_contract.py ${CMAKE_BINARY_DIR})
  set_tests_properties(graphx-vita-live-contract PROPERTIES TIMEOUT 30)
endif()
