...
Preserved intent and proposed acceptance: Bounded LINKTYPE_USER0 PCAPNG per node; 10 messages at 20 ms; final sink sequence 10 and value 20; platform reads only sealed files.

Current source evidence: [source](../../../../examples/capture/run.sh). Source inspection establishes the current contract, not that v3 generation works. All expected artifacts have status `static-design`; proposed execution has not run. Native platform packaging and generic bindings are proposed in every set.
...
|---|---|---|---|---|
| native-linux | 0 / 0 / 0 | 3 / 1 | 0 / 0 / 0 | 0 / 1 / 0 |
| native-macos | 0 / 0 / 0 | 3 / 1 | 0 / 0 / 0 | 0 / 1 / 0 |
| lima | 0 / 0 / 0 | 3 / 1 | 0 / 0 / 0 | 0 / 1 / 0 |
