...
|---|---|---|---|---|
| native-linux | 0 / 1 / 0 | 3 / 0 | 0 / 3 / 1 | 0 / 1 / 0 |
| lima | 0 / 1 / 0 | 3 / 0 | 0 / 3 / 1 | 0 / 1 / 0 |
...
- `planned-privileged`: before apply, allowed-flow passes, denied-flow drops and routed-flow fails; apply the declared /32 route, routed-flow succeeds; clear it and failure returns. Verify new denied traffic independently of established return traffic.
