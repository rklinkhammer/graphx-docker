...
Target: `native-macos`. Expected phase: `compile`. Expected primary error:
`E_TARGET_CAPABILITY` at `target`: C-OVS requires Linux system OVS; native macOS cannot realize it.
