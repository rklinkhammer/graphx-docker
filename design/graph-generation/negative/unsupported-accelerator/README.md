...
Target: `lima`. Expected phase: `compile`. Expected primary error:
`E_TARGET_CAPABILITY` at `nodes.qemu-node.execution.accelerator`: Catalog baseline permits TCG only; KVM requires a separately validated capability.
