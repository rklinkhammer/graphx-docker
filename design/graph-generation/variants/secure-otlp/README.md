...
Preserved intent and proposed acceptance: Explicit secure-otlp settings; default platform retained; credentials by reference; variant acceptance defined in verification.md.

Current source evidence: [source](../../../../examples/variants/secure-otlp/graphx.yml). These review artifacts retain `static-design` status. Actual source-graph execution
