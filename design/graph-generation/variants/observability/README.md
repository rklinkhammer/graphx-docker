...
Preserved intent and proposed acceptance: Explicit observability settings; default platform retained; credentials by reference; variant acceptance defined in verification.md.

Current source evidence: [source](../../../../examples/variants/observability/graphx.yml). These review artifacts retain `static-design` status. Actual source-graph execution
...
|---|---|---|---|---|
| native-linux | 3 / 1 / 2 | 0 / 0 | 0 / 0 / 0 | 0 / 1 / 0 |
| orbstack | 3 / 1 / 2 | 0 / 0 | 0 / 0 / 0 | 0 / 1 / 0 |
| lima | 3 / 1 / 2 | 0 / 0 | 0 / 0 / 0 | 0 / 1 / 0 |
