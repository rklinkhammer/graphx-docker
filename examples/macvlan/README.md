...
```sh
graphx example plan macvlan
graphx example up macvlan --allow-privileged
graphx example status macvlan --allow-privileged
graphx example tokens macvlan --allow-privileged
graphx example logs macvlan --follow --allow-privileged
graphx example down macvlan --allow-privileged
```
