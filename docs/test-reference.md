# GraphX exhaustive test reference

This document is the exhaustive developer/acceptance reference. For the short
profile-based procedure, follow [`test-procedure.md`](test-procedure.md). For the first
...
This reference describes tests for the source model, all five transports, hardened TCP
