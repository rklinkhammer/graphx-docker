...
GRAPHX_GUEST_CONF_OPTS = -DBUILD_SHARED_LIBS=OFF -DGRAPHX_BUILD_TESTS=OFF -DGRAPHX_FORCE_BUNDLED_YAML_CPP=ON -DCMAKE_BUILD_TYPE=Release -DFETCHCONTENT_FULLY_DISCONNECTED=ON -DFETCHCONTENT_SOURCE_DIR_YAML-CPP=/source/deps/yaml-cpp
