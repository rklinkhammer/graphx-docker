...
ARCHIVE_DOCUMENTATION_FILES = frozenset({
    ...
    "share/doc/graphx/docs/README.md",
    "share/doc/graphx/docs/documentation-verification.md",
    "share/doc/graphx/docs/project-decisions.md",
    "share/doc/graphx/docs/release-license-inventory.md",
    "share/doc/graphx/docs/test-procedure.md",
    "share/doc/graphx/docs/user-guide.md",
})
...
ARCHIVE_DATA_FILES = frozenset({
    ...
    "share/graphx/catalog/platform.json",
    "share/graphx/catalog/sources.json",
    "share/graphx/catalog/targets.json",
    "share/graphx/catalog/templates.json",
    "share/graphx/catalog/types/diagnostic.left.json",
    "share/graphx/catalog/types/diagnostic.middle.json",
    "share/graphx/catalog/types/diagnostic.peer.json",
    "share/graphx/catalog/types/diagnostic.right.json",
    "share/graphx/catalog/types/discovery.publisher.json",
    "share/graphx/catalog/types/discovery.subscriber.json",
    "share/graphx/catalog/types/external.packet-source.json",
    "share/graphx/catalog/types/guest.echo.json",
    "share/graphx/catalog/types/sample.sink.json",
    "share/graphx/catalog/types/sample.source.json",
    "share/graphx/catalog/types/sample.transform.json",
    "share/graphx/catalog/types/sdr.processor.json",
    "share/graphx/catalog/types/sdr.radio.json",
    "share/graphx/catalog/types/sdr.result-sink.json",
    "share/graphx/catalog/types/vita.radio.json",
    "share/graphx/catalog/types/vita.processor.json",
    "share/graphx/catalog/types/vita.detector.json",
    "share/graphx/catalog/types/vita.recorder.json",
    "share/graphx/catalog/types/sdr.simulator.json",
    "share/graphx/catalog/types/udp.publisher.json",
    "share/graphx/catalog/types/udp.subscriber.json",
    "share/graphx/catalog/wire-schemas.json",
    "share/graphx/schema/node-type.schema.json",
    "share/graphx/schema/catalog-lock.schema.json",
    "share/graphx/schema/guest-artifact.schema.json",
